        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-md bg-[#0a1210] border border-white/10 text-white placeholder-slate-600 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/40 focus:border-emerald-500/40"
            />
          </div>
          <button
            type="submit"
            className="w-full py-3.5 rounded-md bg-gradient-to-r from-emerald-500 to-emerald-600 text-white font-bold text-sm uppercase tracking-widest border border-emerald-400/25 shadow-[0_0_24px_-6px_rgba(16,185,129,0.65)] hover:from-emerald-400 hover:to-emerald-500 transition-all"
          >
            Send reset link
          </button>
        </form>
