...
const Signup = () => {
  ...
  const getPasswordStrength = () => {
    ...
    const levels = [
      { width: '20%', color: 'bg-rose-500', label: 'Weak' },
      { width: '40%', color: 'bg-amber-500', label: 'Fair' },
      { width: '60%', color: 'bg-amber-400', label: 'Good' },
      { width: '80%', color: 'bg-emerald-400', label: 'Strong' },
      { width: '100%', color: 'bg-emerald-500', label: 'Excellent' },
    ];
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute inset-0 z-20 opacity-10">
          <div className="absolute top-32 left-16 w-80 h-80 bg-emerald-500 rounded-full filter blur-[120px]" />
          <div className="absolute bottom-16 right-16 w-72 h-72 bg-amber-500 rounded-full filter blur-[120px]" />
          <div className="absolute top-1/3 right-1/3 w-64 h-64 bg-cyan-500 rounded-full filter blur-[100px]" />
        </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-arena-950 relative overflow-y-auto">
        <div className="absolute bottom-0 left-0 w-80 h-80 bg-emerald-500/5 rounded-full filter blur-[120px]" />
            ...
            <form onSubmit={handleSubmit} className="space-y-4 animate-fade-in-up">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50 transition-all text-sm"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-3 bg-white/5 border rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 transition-all text-sm ${
