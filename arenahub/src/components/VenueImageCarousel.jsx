...
const emptyByVariant = {
  owner: (
    <div className="w-full h-full flex flex-col items-center justify-center bg-linear-to-br from-zinc-900 to-arena-950">
      <span className="text-4xl mb-2">🏟️</span>
      <span className="text-zinc-500 text-sm font-semibold tracking-widest uppercase">ArenaHub Turf</span>
    </div>
  ),
  player: (
    <div className="w-full h-full flex flex-col items-center justify-center bg-linear-to-br from-zinc-800/80 to-arena-950">
...
export function VenueImageCarousel({ urls, alt, emptyVariant = 'owner' }) {
  ...
  return (
    <div className="relative h-full w-full overflow-hidden bg-slate-900">
      <div
        className="flex h-full w-full transition-transform duration-850 ease-in-out motion-reduce:transition-none"
